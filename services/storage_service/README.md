...
#### Запрос:
```
GET /filter?work_place=None&role=None&date_time_start=2020-02-01&date_time_end=2999-02-28
```
#### Ответ:
```
list совпавших [work_place, role, date_time, text]
...
#### curl:
```
curl -X GET http://127.0.0.1:5730/filter -d "work_place=1"
```
